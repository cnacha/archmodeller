...
/**
 * This is the item provider adapter for a {@link nz.auckland.arch.InterimModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InterimModelItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public InterimModelItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addStepPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_InterimModel_step_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_InterimModel_step_feature",
								"_UI_InterimModel_type"),
						ArchPackage.Literals.INTERIM_MODEL__STEP, true, false, false,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_InterimModel_description_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_InterimModel_description_feature",
								"_UI_InterimModel_type"),
						ArchPackage.Literals.INTERIM_MODEL__DESCRIPTION, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Next Model feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addNextModelPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_InterimModel_nextModel_feature"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ArchPackage.Literals.INTERIM_MODEL__DESIGNMODEL);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/InterimModel"));
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ArchPackage.Literals.INTERIM_MODEL__DESIGNMODEL,
				ArchFactory.eINSTANCE.createDesignModel()));
	}
