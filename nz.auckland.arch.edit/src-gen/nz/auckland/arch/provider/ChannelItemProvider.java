...
/**
 * This is the item provider adapter for a {@link nz.auckland.arch.Channel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChannelItemProvider extends EventItemProvider {
	/**
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Channel_type_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Channel_type_feature", "_UI_Channel_type"),
						ArchPackage.Literals.CHANNEL__TYPE, true, false, false,
	...
	protected void addBindPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Channel_bind_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Channel_bind_feature", "_UI_Channel_type"),
						ArchPackage.Literals.CHANNEL__BIND, true, false, true, null, null, null));
	}
